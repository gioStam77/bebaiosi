    ...
    <>
      <div className="bebaiosi">
        ...
        <p>
          ...
          {dataloaded.asfalismenos} με ΑΜΚΑ {dataloaded.amka + " "} και παρέδωσα
          στον ανωτέρω ασφαλισμένο ΓΥΑΛΙΑ ΟΡΑΣΕΩΣ εκδίδοντας την Απόδειξη
          Παροχής Υπηρεσιών νούμερο {dataloaded.apodeixi}.<br />
      ...
      <div className="apodeixi">
        ...
        <ul>
          {dataloaded.selected === "1" && (
            <li>
              Γυαλιά οράσεως μακρινά με σκελετό {parseInt(dataloaded.poso) / 2}€
              και φακούς
          ...
          {dataloaded.selected === "2" && (
            <li>
              Γυαλιά οράσεως κοντινά με σκελετό {parseInt(dataloaded.poso) / 2}€
              και φακούς
              {parseInt(dataloaded.poso) / 2}€
            </li>
          )}
        ...
        <ul className="telos">
          ...
          <li>
            ...
            ΕΠΑΦΗΣ ΕΙΝΑΙ ΠΡΟΪΟΝΤΑ ΣΥΜΦΩΝΑ ΜΕ ΤΙΣ ΔΙΑΤΑΞΕΙΣ ΤΗΣ ΕΥΡΩΠΑΪΚΗΣ ΕΝΩΣΗΣ
            ΚΑΙ ΠΛΗΡΟΥΝ ΤΟΥ ΚΑΝΟΝΕΣ ΚΑΙ ΤΟΥΣ ΟΡΟΥΣ ΤΗΣ ΣΦΡΑΓΙΔΑΣ ΠΙΣΤΟΠΟΙΗΣΗΣ{" "}
            <span>CE</span>
          </li>
        </ul>
      </div>
